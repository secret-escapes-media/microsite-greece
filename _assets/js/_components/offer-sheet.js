  ...
  $.getJSON(url, function(data) {
    ...
    $(deals).each(function(i){
      ...
      if(this[7]){
        ...
        var htmlImage        = '<div class="bg-img bg-img--16-9" style="background-image: url('+saleImage+')"><div class="offer__expires js-offer-expires p--sm" data-expires="'+saleEndDate+'"></div></div>';
